...
$pdf->SetFont('DejaVu','',15);
   ...
   $pdf->Ln(10);
   $width_cell = array(5,25,93,30,30,52,40);
   ...
   $pdf->Cell($width_cell[5],10,'Ngày đặt',1,0,'C',true);
   ...
   while($row =mysqli_fetch_array($query_lietke_dh)){
    ...
    $pdf->Cell($width_cell[5],10,$row['thoigian'],1,0,'C',$fill);
    $pdf->Cell($width_cell[6],10,number_format($row['soluongmua']*$row['giasp']),1,1,'C',$fill);
    $fill= !$fill;
   }
