<h6 style="text-align: center;text-transform: uppercase;font-weight: bold;">Xem đơn hàng</h6>
<?php
 $code =$_GET['code'];
...
<p  style="text-align: center;padding: 15px 0px;"><a class="btn btn-danger" href="index.php?action=quanlydonhang&query=lietke"><-BACK</a></p>